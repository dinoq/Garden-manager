...
import { IAppObject, IDimensions, IPosition } from "../../../helpers/types";

interface IAppObjectSlice extends IAppObject{

}

const initialState: Array<IAppObjectSlice> = [
]

const AppObjectsSlice = createSlice({
    name: "AppObjectsSlice",
    initialState,
    reducers: {
        createNewFieldAction: (state: Array<IAppObject>, action: PayloadAction<{position: IPosition, dimensions: IDimensions}>) => {
...
export const { /*updateWidthAction, updateHeightAction, updatePositionAction, createNewSeedBedAction, placeSeedBedAction*/ } = AppObjectsSlice.actions;
export default AppObjectsSlice.reducer;